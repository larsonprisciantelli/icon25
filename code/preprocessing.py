...
def main():
    ...
    movieData1 = pd.read_csv(r'datasets\Netflix_serie_film.csv', sep=',')
    movieData2 = pd.read_csv(r'datasets\Netflix_film.csv', sep=',')
    movieRatings = pd.read_csv(r'datasets\IMDb_valutazioni.csv', sep=',')
    ...
    df.to_csv(r'datasets\Netflix_preprocessato.csv', index = False)
    return df
